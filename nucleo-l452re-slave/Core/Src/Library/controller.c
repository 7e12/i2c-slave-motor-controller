 ...
 * @date:    19 Jul 2021
 * @version: v1.0.0
 * @brief:   Nucleo-L452RE I2C slave motor controller
**/
...
void ControllerTaskInit(void) {
    ...
    print(">> Controller Task Init\n");

    HardwareInit();
    osDelay(100);

    // Create empty linked list queue for handling messages
    queue = createLLQueue();
    osDelay(100);
